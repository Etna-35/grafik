...
сотрудника (поля `type=month` «В графике с/по», фронт шлёт `YYYY-MM-01`) ИЛИ из экрана графика (см. ниже). Так:
уволенному ставим «по=июнь» (июнь остаётся по сменам, июль скрыт), новичка — «с=июль» (в июне не виден) ·
